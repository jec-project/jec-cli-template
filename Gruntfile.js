...
/*
 * Provides tasks for building and testing the jec-cli-template project.
 */
module.exports = function(grunt) {
  ...
  /*!
   * JEC CLI TEMPLATE Tasks:
   */

  //--> Task: builds the "jec-cli-template" project:
  grunt.registerTask("build", ["ts:build", "copy:main",
                               "copy:initTypes", "copy:buildTypesFile",
                               "clean:build"]);

  //--> Task: builds the "jec-cli-template" API documentation:
